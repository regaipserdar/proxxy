use hudsucker::{
    ...
    HttpHandler, RequestOrResponse, HttpContext,
};
use tracing::info;
use uuid::Uuid;
...
impl LogHandler {
    pub fn new(
        ...
        Self { metrics, log_sender, scope_matcher: None }
    }
...
impl HttpHandler for LogHandler {
    async fn handle_request(
        ...
        if let Some(sender) = &self.log_sender {
             ...
             use crate::pb::{TrafficEvent, traffic_event, HttpRequestData, HttpHeaders};
             ...
             let event = TrafficEvent {
                 ...
                 event: Some(traffic_event::Event::Request(HttpRequestData {
                     ...
                     headers: Some(HttpHeaders { headers: header_map }),
