import { MousePointer2, Clipboard } from 'lucide-react';

export const BottomPanel = ({ code, isRunning }: { code: string, isRunning: boolean }) => (
  <section className="h-[280px] bg-[#0A0E14] border-t border-white/10 flex p-4 gap-4">
    {/* Code Output Panel */}
    <div className="flex-1 flex flex-col rounded-2xl overflow-hidden border border-white/10 shadow-lg dotted-bg relative">
      ...
      <div className="flex-1 p-6 font-mono text-[12px] leading-relaxed overflow-y-auto bg-[#0D0F13]/80 backdrop-blur-sm relative z-0">
    ...
    <div className="flex-1 flex flex-col rounded-2xl overflow-hidden border border-white/10 shadow-lg dotted-bg relative">
      ...
      <div className="flex-1 p-6 font-mono text-[11px] overflow-y-auto bg-[#0D0F13]/80 backdrop-blur-sm relative z-0">
